      ...
      <div className="max-w-[1500px] mx-auto px-6 w-full">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-[1200px] mx-auto">
          ...
          <div className="bg-[#F5F9FA] rounded-3xl p-10 flex flex-col justify-center">
            ...
            <p className="text-[#666666] leading-relaxed tracking-[-0.5px]">
          ...
          <div className="md:col-span-2 bg-[#F5F9FA] rounded-3xl p-10 ">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div>
                ...
                <p className="text-[#666666] leading-relaxed">
                  We focus on clear design and solid foundations that work
                  today, creating reliable products that deliver value today and
